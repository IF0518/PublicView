...
<h2>Want to close referendum voting.</h2>
<input type="text" name="close" id="close"/><br/>
<input type="submit" value="Close Voting"/>
</form>
</div>
...
if(sub == true){
document.getElementById("close").value="Closed";
return true;
}else
{
return false;
