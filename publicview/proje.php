...
<h1 style="font-size:29px; text-align:center;font-family:serif">General public participation </h1>
</div>
<div class="header1">
<h1 style="font-size:29px; text-align:center;font-family:serif">Project public participation </h1>
</div>
<span style="font-size:25px; text-align:center; color:white;opacity:0.8; font-family:serif"><?php echo $opinion; ?></span>
<span style="color:red; font-size:25"><?php echo $opinion_err; ?></span>
<div class="row">
<div class="col1">
<div class="container">
...
<button class="sum">Summary of Review of constituency boundaries<b>(Click to View/Close)</b></button>
<div class="panel1">
<ul>
<li>Divide constituency according to population there in</li>
...
<textarea id = "text" style="height:100px;width:50%;" name="comment"></textarea><br/><br/>
