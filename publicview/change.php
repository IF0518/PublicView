...
if(empty(mysqli_real_escape_string($link, $_REQUEST['system']))){
$system_err = "Fill in your system_Id to change password";
}
else
{
$sql = "SELECT * FROM users WHERE System_id = ? AND Id_number = ?";
if($stmt = mysqli_prepare($link, $sql)){
mysqli_stmt_bind_param($stmt, "ii", $param_sys, $param_ids);
$param_sys = $_REQUEST['system'];
...
<input type = "text" name="system" placeholder="system_id"><br/>
